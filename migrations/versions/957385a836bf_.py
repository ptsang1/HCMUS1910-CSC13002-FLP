...
Revision ID: 957385a836bf
Revises: a9c80f4ff5e5
Create Date: 2019-12-23 16:33:57.738734
...
revision = '957385a836bf'
down_revision = 'a9c80f4ff5e5'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('comments_in_posts', sa.Column('ownerPostid', sa.VARCHAR(length=100), nullable=False))
    ...
    op.drop_column('comments_in_posts', 'ownerpostid')
...
def downgrade():
    ...
    op.alter_column('genders', 'gendername',
               existing_type=sa.VARCHAR(length=4),
               nullable=False)
    op.add_column('comments_in_posts', sa.Column('ownerpostid', sa.VARCHAR(length=100), autoincrement=False, nullable=False))
